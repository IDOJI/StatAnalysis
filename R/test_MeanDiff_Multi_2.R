test_MeanDiff_Multi_2 = function(data.df, group, variables, exclude_rows=NULL, ex_reasons=NULL, alpha=0.05, alpha_adj=c("None", "Bonferroni"), PostHoc=c("Significant", "All"), round.digits=100, Chronbach=NULL){
  #===========================================================================
  # Adjust Alpha
  #===========================================================================
